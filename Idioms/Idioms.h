...
void object_template();								// 60
void parameterized_base_class();					// 61
void pimpl();										// 62
void policy_clone();								// 63
void policy_based_design();							// 64
void polymorphic_exception();						// 65
void polymorphic_value_types();						// 66
