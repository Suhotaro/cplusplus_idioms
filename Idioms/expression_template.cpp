...
// As I understand the idea is creating expression without its calculations

/*

1) To create a domain-specific embedded language (DSEL) in C++
2) support lazy evaluation of C++ expressions (e.g., mathematical expressions), which can be executed much later in the program from the point of their definition.
3) pass an expression -- not the result of the expression -- as a parameter to a function.
